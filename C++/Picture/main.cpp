...
class Picture {
    ...
    public:
        ...
        Picture(
                Line* _lptr, int _lsize, Rect* _rptr, int _rsize,
                Triangle* _tptr, int _tsize, Circle* _cptr, int _csize
                ) {
            lptr = _lptr;
            lsize = _lsize;
            rptr = _rptr;
...
int main() {
    ...
    Line lines[4] = {line1, line2, line3};
    ...
    Circle circles[2] = {c1, c2};

    Picture picture;
    picture.setLines(lines, 6);
    picture.setRects(&rect, 1);
    picture.setTriangles(&triangle, 1);
    picture.setCircles(circles, 2);
    picture.DoIt();
    ...
    picture.setRects(nullptr, 0);
    picture.setTriangles(nullptr, 0);
    picture.setCircles(nullptr, 0);
}
